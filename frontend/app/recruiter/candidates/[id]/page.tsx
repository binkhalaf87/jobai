...
type Tab = "analysis" | "matches" | "resume" | "notes";
...
function TabResume({ detail }: { detail: CandidateDetail }) {
  if (!detail.raw_text) {
    return (
      <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 p-8 text-center">
        <p className="text-sm text-slate-500">Resume text not available.</p>
      </div>
    );
  }
  return (
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="pb-8">
        ...
        {activeTab === "resume" && <TabResume detail={detail} />}
